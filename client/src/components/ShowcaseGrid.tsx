...
const cardData = [
  {
    ...
    content: (
      <div className="p-6 h-full flex flex-col justify-end">
        <h2 className="text-xl font-bold text-white">Driven by Excellence</h2>
  ...
  },
  {
    ...
    content: (
      <div className="h-full flex flex-col justify-center items-center text-center p-6">
        <img src="/images/logos/clickbit-logo-single-color-light.svg" alt="ClickBit Logo" className="w-32 mb-4" loading="lazy" />
