...
// Data for each process phase with richer content and specific deliverable icons
const processPhases = [
  {
    id: 1,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 px-4">
          <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-800 dark:text-white">
            Our Path to <span className="bg-gradient-to-r from-[#1FBBD2] to-[#F39C12] text-transparent bg-clip-text">Your Success</span>
          </h2>
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            A transparent and collaborative process designed for results. We follow a
            structured four-phase approach to ensure quality and clarity from start to finish.
          </p>
        </div>
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex items-center mb-6">
                  <div className={`text-white p-3 rounded-full bg-gray-800 dark:bg-gray-900 inline-flex items-center justify-center shadow-md mr-5 ${phase.color}`}>
                    <phase.mainIcon size={28} strokeWidth={2.5} className="text-white" />
                  </div>
                  <div>
                    ...
                    >
                      ...
                      <ul className="flex flex-wrap gap-2 text-sm font-medium">
                        {phase.deliverables.map((item, i) => (
                          ...
                          >
                            <item.icon size={16} className={`mr-2 ${phase.color}`} />
                            <span>{item.text}</span>
                          </motion.li>
                        ))}
                      </ul>
