...
import { Facebook, Instagram, Linkedin, Youtube, Mail, Phone, MapPin, ArrowUp, Github } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-16 sm:py-24 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12">
          ...
          <div className="text-center md:text-left">
            ...
            <Link to="/contact" className="mt-6 inline-block w-full text-center px-6 py-3 border border-transparent text-base font-semibold rounded-full text-white bg-cyan-600 hover:bg-cyan-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
              Send a Message
            </Link>
          </div>
        </div>
